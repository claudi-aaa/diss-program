...
from amino_acid import reassign_aa, make_partition, gen_aa_chain, record_aa, record_org_aa, record_aa_assignment, make_new_aa_phy, make_org_aa_phy, generate_aa_chain_list, reassign_aa_by_weight
...
def program_3(k, seq, runs, wf, branches, base_tree, main_path, splits_path):
    for run_no in range(1, runs + 1):
        ...
        new_aa_dict = reassign_aa_by_weight(kmer_size, BASES)
